...
# Define paths ----
raw_path <- here::here("01_rawdata")
processed_path <- here::here("02_processed")
result_path <- here::here("04_results")

# Load calibration file
sims <- read.csv(file.path(processed_path, "AllSimulations.csv"))

meta <- read_excel("C:/Users/Lenovo/Documents/SCIENCE/PhD/5. LittleLeo/Drag modelling/02_processed/Result_summary.xlsx")

mesh <- read_excel("C:/Users/Lenovo/Documents/SCIENCE/PhD/5. LittleLeo/Drag modelling/02_processed/Result_summary.xlsx", sheet = "Mesh dependancy")
